== NoAgenda Attack Vector Dashboard
...
* Rails 3.0.10 (probably updating to 3.1 soon - just need to make sure I can host it without issues first)
* InheritedResources and haml for super thin controllers and views
* elycharts (with jQuery and Raphaël)
* iPad friendly fixed-layout (using iScroll)
...
link:https:noagenda_dashboard/blob/master/config/locales/en.yml
